...
enum class ErrorCode(
    ...
    RECOVERY_CODE_INVALID(HttpStatus.BAD_REQUEST, "RECOVERY_CODE_INVALID", "The recovery code is invalid"),
    RECOVERY_ATTEMPT_RATE_LIMITED(HttpStatus.TOO_MANY_REQUESTS, "RECOVERY_ATTEMPT_RATE_LIMITED", "Too many recovery attempts"),
